...
const SkillCard = ({ skill }: { skill: { name: string; category: string; id: string } }) => {
    ...
    return (
        <div
            ...
            className="skill-card relative flex flex-col items-center justify-center p-8 rounded-2xl bg-white/[0.02] border border-white/5 overflow-hidden transition-colors duration-300"
        >
            <div
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 pointer-events-none">
                <div 
                    ref={iconRef} 
                    className="size-16 rounded-2xl bg-white/5 flex items-center justify-center border border-white/5 shadow-sm"
                >
                    <img 
